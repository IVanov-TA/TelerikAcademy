namespace StudentsListTasks
{
    using System;
    using System.Collections.Generic;
    using System.Linq;

    public class SelectByTwoMarks
    {
        private static List<Students> students = new List<Students>();

        public SelectByTwoMarks()
        {
        ...
        {
            var selected = students.FindAll(x => x.Marks.FindAll(y => y == 2).Count() == 2).Select(student => student + " | Marks: " + string.Join(" ", student.Marks));
